 ...
 * 30 大核心戰術攻擊神兵武器庫 (分為 4 大難度強度階級)
 * - 🟢 簡單階 (Easy Tier): 8 款基礎牽制神兵
 * - 🔵 普通階 (Normal Tier): 8 款戰術連攜神兵
 * - 🟣 困難階 (Hard Tier): 7 款高壓穿透神兵
 * - 🔴 噩夢階 (Nightmare Tier): 7 款終極毀滅神兵
 * 
 * 體系特色：
 * 1. 取消下蹲：雙方皆不蹲下，防禦統一為主動量子防護罩。
 * 2. 拳腳體術：踢腿與拳擊為 AI 專屬體術；玩家專注於自選神兵武裝！
 * 3. AI 抽取：AI 每場依難度從對應強度的武器庫中隨機抽取 3 把神兵武器！
 */
...
/**
 * 依難度隨機抽取 AI 出戰的 3 把武器
 */
export function getRandomAiWeapons(difficulty = 'normal', count = 3) {
